        ...
        <div class="row justify-content-between">
          <div class="col-lg-5 d-flex align-items-center justify-content-center about-img">
            <div class="button-income">
             ...
             <a href="hitungsendiri.html"><button class="button-hitung" type="button">Hitung Sendiri</button><br></a>
              <a href="income.html"><button class="button-package" type="button">Lihat Paket yang tersedia</button></a>
          </div>
          </div>
